...
struct ChainConfig {
    ...
    /// @notice Auto-approved hyperstructure on mainnet for enabling DIGI v3 with less gas. Deprecated – safe to set to address(0x)
...
abstract contract DeploymentConfig is StdChains, StdCheatsSafe, StdUtils, ScriptBase {
    ...
    string constant DIGI_ERC721_TRANSFER_HELPER = "DIGI_ERC721_TRANSFER_HELPER";
    ...
    string constant DIGI_NFT_CREATOR_PROXY = "DIGI_NFT_CREATOR_PROXY";
    string constant DIGI_NFT_CREATOR_V1_IMPL = "DIGI_NFT_CREATOR_V1_IMPL";
    ...
    function getChainConfig() internal view returns (ChainConfig memory chainConfig) {
        ...
        chainConfig.zoraERC721TransferHelper = json.readAddress(getKeyPrefix(DIGI_ERC721_TRANSFER_HELPER));
    ...
    function getDeployment() internal view returns (DropDeployment memory dropDeployment) {
        ...
        dropDeployment.factory = json.readAddress(getKeyPrefix(DIGI_NFT_CREATOR_PROXY));
        dropDeployment.factoryImpl = json.readAddress(getKeyPrefix(DIGI_NFT_CREATOR_V1_IMPL));
    }
