...
contract DeployNewERC721Drop is Script {
    ...
    function run() public {
        ...
        address creatorProxy = _getKey("DIGI_NFT_CREATOR_PROXY");
        ...
        DiGiNFTCreatorV1 zoraNFTCreator = DiGiNFTCreatorV1(creatorProxy);
        ...
        zoraNFTCreator.upgradeTo(_getKey("DIGI_NFT_CREATOR_V1_IMPL"));
