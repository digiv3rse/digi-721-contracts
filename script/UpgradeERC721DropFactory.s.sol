...
import {IDiGiFeeManager} from "../src/interfaces/IDiGiFeeManager.sol";
import {IFactoryUpgradeGate} from "../src/interfaces/IFactoryUpgradeGate.sol";
import {ERC721DropProxy} from "../src/ERC721DropProxy.sol";
import {IERC721Drop} from "../src//interfaces/IERC721Drop.sol";

contract UpgradeERC721DropFactory is DiGiDropsDeployBase {
    function run() public returns (string memory) {
        ...
        DiGiNFTCreatorV1 newDiGiNFTCreatorImpl = new DiGiNFTCreatorV1({
        ...
        deployment.factoryImpl = address(newDiGiNFTCreatorImpl);

        console2.log("Factory/Creator IMPL: ");
        console2.log(address(newDiGiNFTCreatorImpl));

        address deployer = vm.envAddress("DEPLOYER");

        deployTestContractForVerification(newDiGiNFTCreatorImpl, deployer);
