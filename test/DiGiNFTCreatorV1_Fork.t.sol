...
import "../src/DiGiNFTCreatorV1.sol";
import "../src/DiGiNFTCreatorProxy.sol";
...
contract DiGiNFTCreatorV1Test is Test, ForkHelper {
    ...
    DiGiNFTCreatorV1 public creator;
    ...
    function testForkEdition() external {
        ...
        for (uint256 i = 0; i < forkTestChains.length; i++) {
            ...
            creator = DiGiNFTCreatorV1(getDeployment().factory);
    ...
    function verifyAddressesFork(string memory chainName) internal {
        ...
        if (factoryImpl != deployment.factoryImpl) {
            ...
            creator = DiGiNFTCreatorV1(deployment.factory);
    ...
    function revertsWhenContractNameMismatches() internal {
        DiGiNFTCreatorV1 newCreatorImpl = new DiGiNFTCreatorV1(address(dropImpl), editionMetadataRenderer, dropMetadataRenderer);
        ...
        vm.prank(owner);
        vm.expectRevert(abi.encodeWithSignature("UpgradeToMismatchedContractName(string,string)", "DIGI NFT Creator", "test name"));
    ...
    function forkUpgradeSucceedsWithMatchingContractName() internal {
        ...
        MockContractMetadata mockMetadata = new MockContractMetadata("uri", "DIGI NFT Creator");
