...
contract ERC721DropTest is Test {
    ...
    address payable public constant DEFAULT_DIGI_DAO_ADDRESS = payable(address(0x999));
    ...
    modifier setupDiGiNFTBase(uint64 editionSize) {
    ...
    modifier setupDiGiNFTBaseWithCreateReferral(uint64 editionSize, address initCreateReferral) {
        bytes[] memory setupCalls = new bytes[](0);
        zoraNFTBase.initialize({
            _contractName: "Test NFT",
            _contractSymbol: "TNFT",
    ...
    function setUp() public {
        ...
        vm.prank(DEFAULT_DIGI_DAO_ADDRESS);
    ...
    function test_Init() public setupDiGiNFTBase(10) {
    ...
    function test_IsAdminGetter() public setupDiGiNFTBase(1) {
    ...
    function test_RoyaltyInfo() public setupDiGiNFTBase(10) {
        // assert 800 royaltyAmount or 8%
        (, uint256 royaltyAmount) = zoraNFTBase.royaltyInfo(10, 1 ether);
        assertEq(royaltyAmount, 0.08 ether);
    }

    function test_NoRoyaltyInfoNoFundsRecipientAddress() public setupDiGiNFTBase(10) {
    ...
    function test_PurchaseFreeMint(uint32 purchaseQuantity) public setupDiGiNFTBase(purchaseQuantity) {
    ...
    function test_PurchaseWithValue(uint64 salePrice, uint32 purchaseQuantity) public setupDiGiNFTBase(purchaseQuantity) {
    ...
    function test_PurchaseWithComment(uint64 salePrice, uint32 purchaseQuantity) public setupDiGiNFTBase(purchaseQuantity) {
        vm.assume(purchaseQuantity < 100 && purchaseQuantity > 0);
        vm.prank(DEFAULT_OWNER_ADDRESS);
        zoraNFTBase.setSaleConfiguration({
            publicSaleStart: 0,
    ...
    function test_PurchaseWithRecipient(uint64 salePrice, uint32 purchaseQuantity) public setupDiGiNFTBase(purchaseQuantity) {
        vm.assume(purchaseQuantity < 100 && purchaseQuantity > 0);
        vm.prank(DEFAULT_OWNER_ADDRESS);
        zoraNFTBase.setSaleConfiguration({
            publicSaleStart: 0,
    ...
    function test_PurchaseWithRecipientAndComment(uint64 salePrice, uint32 purchaseQuantity) public setupDiGiNFTBase(purchaseQuantity) {
        vm.assume(purchaseQuantity < 100 && purchaseQuantity > 0);
        vm.prank(DEFAULT_OWNER_ADDRESS);
        zoraNFTBase.setSaleConfiguration({
            publicSaleStart: 0,
    ...
    function testRevert_PurchaseWithInvalidRecipient(uint64 salePrice, uint32 purchaseQuantity) public setupDiGiNFTBase(purchaseQuantity) {
        vm.assume(purchaseQuantity < 100 && purchaseQuantity > 0);
        vm.prank(DEFAULT_OWNER_ADDRESS);
        zoraNFTBase.setSaleConfiguration({
            publicSaleStart: 0,
    ...
    function test_FreeMintRewards(uint32 purchaseQuantity) public setupDiGiNFTBase(purchaseQuantity) {
        vm.assume(purchaseQuantity < 100 && purchaseQuantity > 0);
    ...
    function test_FreeMintRewardsWithMintReferral(uint32 purchaseQuantity) public setupDiGiNFTBase(purchaseQuantity) {
        vm.assume(purchaseQuantity < 100 && purchaseQuantity > 0);
    ...
    function test_FreeMintRewardsWithCreateReferral(uint32 purchaseQuantity) public setupDiGiNFTBaseWithCreateReferral(purchaseQuantity, createReferral) {
        vm.assume(purchaseQuantity < 100 && purchaseQuantity > 0);
    ...
    ) public setupDiGiNFTBaseWithCreateReferral(purchaseQuantity, createReferral) {
        vm.assume(purchaseQuantity < 100 && purchaseQuantity > 0);
    ...
    function testRevert_FreeMintRewardsInsufficientEth(uint32 purchaseQuantity) public setupDiGiNFTBase(purchaseQuantity) {
        vm.assume(purchaseQuantity < 100 && purchaseQuantity > 0);
    ...
    function test_PaidMintRewards(uint64 salePrice, uint32 purchaseQuantity) public setupDiGiNFTBase(purchaseQuantity) {
        vm.assume(salePrice > 0);
        vm.assume(purchaseQuantity < 100 && purchaseQuantity > 0);
    ...
    function test_PaidMintRewardsWithMintReferral(uint64 salePrice, uint32 purchaseQuantity) public setupDiGiNFTBase(purchaseQuantity) {
        vm.assume(salePrice > 0);
        vm.assume(purchaseQuantity < 100 && purchaseQuantity > 0);
    ...
    function testRevert_PaidMintRewardsInsufficientEth(uint64 salePrice, uint32 purchaseQuantity) public setupDiGiNFTBase(purchaseQuantity) {
        vm.assume(salePrice > 0);
        vm.assume(purchaseQuantity < 100 && purchaseQuantity > 0);
    ...
    function test_UpgradeApproved() public setupDiGiNFTBase(10) {
    ...
    function test_UpgradeFailsNotApproved() public setupDiGiNFTBase(10) {
    ...
    function test_PurchaseTime() public setupDiGiNFTBase(10) {
        vm.prank(DEFAULT_OWNER_ADDRESS);
        zoraNFTBase.setSaleConfiguration({
            publicSaleStart: 0,
            publicSaleEnd: 0,
    ...
    function test_Mint() public setupDiGiNFTBase(10) {
        vm.prank(DEFAULT_OWNER_ADDRESS);
    ...
    function test_MulticallAccessControl() public setupDiGiNFTBase(10) {
        vm.prank(DEFAULT_OWNER_ADDRESS);
        zoraNFTBase.setSaleConfiguration({
            publicSaleStart: 0,
            publicSaleEnd: type(uint64).max,
    ...
    function test_MintMulticall() public setupDiGiNFTBase(10) {
    ...
    function test_UpdatePriceMulticall() public setupDiGiNFTBase(10) {
        vm.startPrank(DEFAULT_OWNER_ADDRESS);
        bytes[] memory calls = new bytes[](3);
    ...
    function test_MintWrongValue() public setupDiGiNFTBase(10) {
        vm.deal(address(456), 1 ether);
        vm.prank(address(456));
        vm.expectRevert(IERC721Drop.Sale_Inactive.selector);
    ...
    function test_Withdraw(uint128 amount) public setupDiGiNFTBase(10) {
    ...
    function test_WithdrawNoDiGiFee(uint128 amount) public setupDiGiNFTBase(10) {
        vm.assume(amount > 0.01 ether);
    ...
    function test_MintLimit(uint8 limit) public setupDiGiNFTBase(5000) {
    ...
    function testSetSalesConfiguration() public setupDiGiNFTBase(10) {
        vm.prank(DEFAULT_OWNER_ADDRESS);
        zoraNFTBase.setSaleConfiguration({
            publicSaleStart: 0,
            publicSaleEnd: type(uint64).max,
    ...
    function test_GlobalLimit(uint16 limit) public setupDiGiNFTBase(uint64(limit)) {
        vm.assume(limit > 0);
        vm.startPrank(DEFAULT_OWNER_ADDRESS);
    ...
    function test_WithdrawNotAllowed() public setupDiGiNFTBase(10) {
        vm.expectRevert(IERC721Drop.Access_WithdrawNotAllowed.selector);
        zoraNFTBase.withdraw();
    }

    function test_InvalidFinalizeOpenEdition() public setupDiGiNFTBase(5) {
        vm.prank(DEFAULT_OWNER_ADDRESS);
        zoraNFTBase.setSaleConfiguration({
            publicSaleStart: 0,
            publicSaleEnd: type(uint64).max,
    ...
    function test_ValidFinalizeOpenEdition() public setupDiGiNFTBase(type(uint64).max) {
        vm.prank(DEFAULT_OWNER_ADDRESS);
        zoraNFTBase.setSaleConfiguration({
            publicSaleStart: 0,
            publicSaleEnd: type(uint64).max,
    ...
    function test_AdminMint() public setupDiGiNFTBase(10) {
    ...
    function test_EditionSizeZero() public setupDiGiNFTBase(0) {
        address minter = address(0x32402);
        vm.startPrank(DEFAULT_OWNER_ADDRESS);
        vm.expectRevert(IERC721Drop.Mint_SoldOut.selector);
        zoraNFTBase.adminMint(DEFAULT_OWNER_ADDRESS, 1);
    ...
    // test Admin airdrop
    function test_AdminMintAirdrop() public setupDiGiNFTBase(1000) {
        vm.startPrank(DEFAULT_OWNER_ADDRESS);
    ...
    function test_AdminMintAirdropFails() public setupDiGiNFTBase(1000) {
    ...
    function test_AdminMintBatch() public setupDiGiNFTBase(1000) {
        vm.startPrank(DEFAULT_OWNER_ADDRESS);
    ...
    function test_AdminMintBatchFails() public setupDiGiNFTBase(1000) {
        vm.startPrank(address(0x10));
    ...
    function test_Burn() public setupDiGiNFTBase(10) {
        address minter = address(0x32402);
        vm.startPrank(DEFAULT_OWNER_ADDRESS);
        zoraNFTBase.grantRole(zoraNFTBase.MINTER_ROLE(), minter);
        vm.stopPrank();
    ...
    function test_BurnNonOwner() public setupDiGiNFTBase(10) {
        address minter = address(0x32402);
        vm.startPrank(DEFAULT_OWNER_ADDRESS);
        zoraNFTBase.grantRole(zoraNFTBase.MINTER_ROLE(), minter);
        vm.stopPrank();
    ...
    function test_AdminMetadataRendererUpdateCall() public setupDiGiNFTBase(10) {
        vm.startPrank(DEFAULT_OWNER_ADDRESS);
    ...
    function test_NonAdminMetadataRendererUpdateCall() public setupDiGiNFTBase(10) {
    ...
    function test_SupplyRoyaltyMintScheduleCannotBeOne() public setupDiGiNFTBase(100) {
        vm.startPrank(DEFAULT_OWNER_ADDRESS);
        vm.expectRevert(IERC721Drop.InvalidMintSchedule.selector);
        zoraNFTBase.updateRoyaltyMintSchedule(1);
    }

    function test_SupplyRoyaltyPurchase(uint32 royaltyMintSchedule, uint32 editionSize, uint256 mintQuantity) public setupDiGiNFTBase(editionSize) {
    ...
    function test_SupplyRoyaltyCleanNumbers() public setupDiGiNFTBase(100) {
        vm.startPrank(DEFAULT_OWNER_ADDRESS);
    ...
    function test_SupplyRoyaltyEdgeCaseNumbers() public setupDiGiNFTBase(137) {
        vm.startPrank(DEFAULT_OWNER_ADDRESS);
    ...
    function test_SupplyRoyaltyEdgeCaseNumbersOpenEdition() public setupDiGiNFTBase(type(uint64).max) {
        vm.startPrank(DEFAULT_OWNER_ADDRESS);
