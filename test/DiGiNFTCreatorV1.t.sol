...
contract DiGiNFTCreatorV1Test is Test {
    address public constant DEFAULT_OWNER_ADDRESS = address(0x23499);
    address payable public constant DEFAULT_FUNDS_RECIPIENT_ADDRESS =
        payable(address(0x21303));
    address payable public constant DEFAULT_DIGI_DAO_ADDRESS =
    ...
    function setUp() public {
        ...
        DiGiNFTCreatorV1 impl = new DiGiNFTCreatorV1(
            address(dropImpl),
            editionMetadataRenderer,
            dropMetadataRenderer
        );
        creator = DiGiNFTCreatorV1(
            address(
                new DiGiNFTCreatorProxy(
                    address(impl),
                    abi.encodeWithSelector(DiGiNFTCreatorV1.initialize.selector)
                )
            )
        );
    }
    ...
    function test_ContractName() public {
        assertEq(creator.contractName(), "DIGI NFT Creator");
    }
