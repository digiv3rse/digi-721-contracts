...
contract DiGiNFTBaseTest is Test {
    ...
    function test_MerklePurchaseActiveSuccess() public setupDiGiNFTBase {
    ...
    function test_MerklePurchaseFailureWrongPrice() public setupDiGiNFTBase {
        vm.startPrank(DEFAULT_OWNER_ADDRESS);
        zoraNFTBase.setSaleConfiguration({
            publicSaleStart: 0,
            publicSaleEnd: 0,
    ...
    function test_MerklePurchaseFailureWrongRoot() public setupDiGiNFTBase {
        vm.startPrank(DEFAULT_OWNER_ADDRESS);
        zoraNFTBase.setSaleConfiguration({
            publicSaleStart: 0,
            publicSaleEnd: 0,
    ...
    function test_MerklePurchaseAndPublicSalePurchaseLimits() public setupDiGiNFTBase {
        vm.startPrank(DEFAULT_OWNER_ADDRESS);
        zoraNFTBase.setSaleConfiguration({
            publicSaleStart: 0,
    ...
    function test_MerklePurchaseInactiveFails() public setupDiGiNFTBase {
        vm.startPrank(DEFAULT_OWNER_ADDRESS);
